...
Boilerplate.
    ...
    >>> _ = wbemocks.patch_skip_chrome_canvas()
...
Test loading a url with a fragment.
    ...
    >>> url = 'http://wbemocks.test/chapter7-fragment1'
    ...
    'http://wbemocks.test/chapter7-fragment1#target'
...
Test clicking on a link with an absolute path including a fragment.
    ...
    >>> url = 'http://wbemocks.test/chapter7-fragment3'
    ...
    >>> this_browser.tabs[0].url
    'http://wbemocks.test/chapter7-fragment3#fullpath'
...
This should only scroll the existing page, and not reload the contents of the
  page.
    ...
    >>> url = 'http://wbemocks.test/chapter7-fragment4'
...
Click on the relative fragment.
    ...
    >>> this_browser.tabs[0].url
    'http://wbemocks.test/chapter7-fragment4#relpath'
...
If the fragment does not exist then don't change the scroll position.
    ...
    >>> url = 'http://wbemocks.test/chapter7-fragment5'
    ...
    >>> this_browser.tabs[0].url
    'http://wbemocks.test/chapter7-fragment5#heyo'
...
Clicking a fragment link when a fragment url is already loaded should
  replace the fragment.
    ...
    >>> url = 'http://wbemocks.test/chapter7-fragment6'
    >>> body = ('<a href="#relpath">Relative path link</a>'
    ...         + 'i<br>'*34
    ...         + '<h1 id="relpath">Relative path target</h1>'
    ...         + 'j<br>'*60
    ...
    >>> this_browser.tabs[0].url
    'http://wbemocks.test/chapter7-fragment6#relpath'
